    ...
    <div className="DemonSlayerCard min-h-[80vh] flex justify-center items-center flex-wrap relative">
      <div className="DemonSlayerCardContainer w-full h-full flex justify-center items-center">
        <div className="Cards w-full flex flex-wrap justify-around items-center">
          ...
          >
            <div className="Card overflow-hidden text-center relative w-[270px] sm:w-[21vw]  sm:h-[21vw] h-[300px] bg-[url('/assets/images/nezuko.jpg')] bg-center bg-no-repeat bg-cover rounded-[50px] shadow-[30px_30px_40px_#141313,-30px_-30px_40px_#1c1919] transform scale-105 m-8 cursor-pointer">
              <div className="Colour absolute w-full h-[15%] bg-[linear-gradient(125deg,rgba(255,60,14,1)_28%,rgba(255,255,102,1)_89%)] right-[120px] top-[40px] transform rotate-[-45deg] translate-y-[-90px]"></div>
              <div className="CardText opacity-0 relative top-[80px] text-[120%]">
                <h3>Nezuko</h3>
                <p>
          ...
          >
            <div className="Card overflow-hidden text-center relative w-[270px] sm:w-[21vw]  sm:h-[21vw] h-[300px] bg-[url('/assets/images/zenitsu.jpg')] bg-center bg-no-repeat bg-cover rounded-[50px] shadow-[30px_30px_40px_#141313,-30px_-30px_40px_#1c1919] transform scale-105 m-8 cursor-pointer">
              <div className="Colour absolute w-full h-[15%] bg-[linear-gradient(125deg,rgba(255,60,14,1)_28%,rgba(255,255,102,1)_89%)] right-[120px] top-[40px] transform rotate-[-45deg] translate-y-[-90px]"></div>
              <div className="CardText opacity-0 relative top-[80px] text-[120%]">
                <h3>Zenitsu</h3>
                <p>
